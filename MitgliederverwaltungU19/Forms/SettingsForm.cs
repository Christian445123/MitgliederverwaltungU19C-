...
public sealed class SettingsForm : Form
{
    ...
    public SettingsForm(AppSettings settings, bool firstRun)
    {
        ...
        var intro = new Label
        {
            ...
            Text = "Trage die Adresse der Web-Anwendung und einen API-Schlüssel ein. " +
                   "Den Schlüssel erstellt ein Administrator im Web-Bereich unter „API-Zugang“. Die gesamte Übertragung wird automatisch verschlüsselt.",
    ...
    private async Task TestAsync()
    {
        ...
        {
            SetStatus("Bitte Adresse und API-Schlüssel eintragen.", false);
            return;
        }
